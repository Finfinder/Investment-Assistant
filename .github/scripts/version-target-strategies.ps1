# Vendored from Finfinder/AI_Instruction on 2026-04-30 as a companion to validate-version-consistency.ps1.
# Keep this file in sync with the source repository when the underlying version target logic changes.
