...
def build_report(
    ...
    pattern_scanner_results: list[PatternScannerResult] | None = None,
    ...
    return AnalysisReport(
        ...
        timeframe_context=timeframe_context or AnalysisTimeframeContext(),
        ohlcv_data=ohlcv,
        technical_indicators=indicators,
        moving_averages=moving_averages,
        pivot_points=pivot_points,
        patterns=patterns,
        pattern_scanner_results=pattern_scanner_results or [],
